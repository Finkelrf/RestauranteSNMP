...
begin with the estoqueTable prefix.
...
------------------------------------------------------------------------
  ...
  Editable: Optional
  Usage   : make -f estoqueTable_Makefile


  File    : estoqueTable_subagent.c
  ----------------------------------------------------------------------
...
should probably read these next:
   ...
   estoqueTable-README-estoqueTable.txt
