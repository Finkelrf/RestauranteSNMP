...
------------------------------------------------------------------------
  ...
  the ordersTable table.  The agent will start by looking for the right
  ...
  file defaults/table-ordersTable.m2d, and then re-running mib2c.
    ...
    will be generated:
      ...
      ordersTable_allocate_data
      ordersTable_release_data
 ...
 Index(es) for the ordersTable table
  ------------------------------------------------------------
  The index(es) for the ordersTable table are:
...
************************************************************************
ordersTable File Overview
------------------------------------------------------------------------
  Several files have been generated to implement the ordersTable
  table. We'll go through these files, one by one, explaining each and
  letting you know which you need to edit.


File: ordersTable_data_access.[c|h]
------------------------------------------------------------------------
  The ordersTable_data_access file contains the interface to your data in
  ...
  FUNC : ordersTable_indexes_set
  WHERE: ordersTable_data_access.c
...
NOTE: Depending on your configuration, some of the functions used in the
      ...
      were generated for the ordersTable table.

To watch the flow of the ordersTable table, use the
following debug tokens:
        ...
        ordersTable
        verbose:ordersTable
        internal:ordersTable

e.g.
        snmpd -f -Le -DordersTable,verbose:ordersTable,internal:ordersTable
...
/*---------------------------------------------------------------------
 * RestCtrl-MIB::ordersEntry.ordersIndex
 * ordersIndex is subid 1 of ordersEntry.
 * Its status is Mandatory, and its access level is ReadOnly.
 * OID: .1.3.6.1.4.1.12619.4.1.1
 * Description:
